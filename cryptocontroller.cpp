...
void cryptoController::encrypt_login_or_password(QString password) {
    ...
    QFile out("D:\\Study\\QT\\Lab_2\\out.txt");
    ...
    QFile in("D:\\Study\\QT\\Lab_2\\in.txt");
...
//    encrypt_login_or_password("1568");
    ...
    char buffer[256] = {0};
    QFile source_file("D:\\Study\\QT\\Lab_2\\password_crypt.txt");
...
void cryptoController::encrypt_db_file(QString password, int record_id, int is_password)
{
    ...
    EVP_CIPHER_CTX *ctx;
        ...
        QFile file("D:\\Study\\QT\\Lab_2\\db_crypt.json");
        file.open(QIODevice::WriteOnly);

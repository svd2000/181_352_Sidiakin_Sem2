...
ApplicationWindow {
    ...
    height: 480
    visible: true
    title: qsTr("Лабораторная работа №2 (Sidiakin Vasiliy, гр. 191-351)")
    ...
    Connections {text_to
            ...
            onSendDbToQml: {
                ...
                for(let i = 0; i < json_db["sites"].length; i++) {
                    ...
                    listmodel1.append(json_db_model) //листы заполняются при инициализации
    ...
    function crypt_controller(password) { //функция дешифрования
...
//                    }
                ...
                ListView {
                    ...
                    model:ListModel { // 1 лист который выводится
                        id: listmodel1
                        // Items таблицы бд
                    }
                }
